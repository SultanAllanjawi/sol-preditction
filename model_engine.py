...
cat > /home/claude/model_engine_v5.py << 'PYEOF'
"""
model_engine.py v5
Models:
...
PYEOF
python3 -c "import ast; ast.parse(open('/home/claude/model_engine_v5.py').read()); print('✅ Syntax valid')"
wc -l /home/claude/model_engine_v5.py
Output

✅ Syntax valid
336 /home/claude/model_engine_v5.py
